module.exports= function(managerName,messageResponse){
    ...
    return(
        ...
        managerName+' responded to your comment:'+
        '</h3>'+
        '<p style="font-style: italic; line-height: 1.125rem; color: #667284; padding:10px;">'+
        messageResponse+'</p>'+
